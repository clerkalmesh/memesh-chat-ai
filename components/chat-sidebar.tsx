      ...
      <div className="flex h-full flex-col">
        <div className="p-4">
          <Link href={"/"} className="flex items-center space-x-2 mb-4">
            ...
            <span className="font-semibold">MESH AI</span>
          </Link>
          <Button
        ...
        <Separator />
        {/* Pemberitahuan Pengguna Anonim */}
        {isAnonymous && (
          <div className="p-4">
            <Card className="border">
              <CardContent className="p-3">
                <p className="text-sm mb-2 text-destructive">
                  💡 Anda chatting secara anonim
                </p>
            ...
            {chats?.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-sm text-muted-foreground">
                  {isAnonymous ? "Tidak ada chat tersimpan" : "Belum ada chat"}
                </p>
                <p className="text-xs text-muted-foreground">
                  {isAnonymous
                    ? "Masuk untuk menyimpan percakapan"
                    : "Mulai percakapan untuk melihat chat Anda di sini"}
                </p>
              </div>
            ) : (
